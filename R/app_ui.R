...
app_ui <- function(request) {
  tagList(
      ...
      tabPanel(
        ...
        sidebarPanel(
          ...
          conditionalPanel("input.start_vip",
                           helpText("O usuário VIP possui acesso direto ao seu portfólio fornecendo sua chave de acesso. Para saber como configurar uma chave de acesso consulte: ", 
    ...
    ,
    tags$footer(
      div(textOutput("currentTime"),style = "position: fixed; left: 0; bottom: 0; width: 100%; text-color: rgb(188, 188, 188); background-color: transparent; color: white; text-align: right;"),
      HTML("
      ...
      </footer>"), style = "position: fixed; left: 0; bottom: 0; width: 100%; text-color: rgb(188, 188, 188); background-color: rgb(46, 51, 54); color: white; text-align: center;")
  )
}
